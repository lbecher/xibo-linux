...
namespace Resources
{
    ...
    namespace Ui
    {
        const std::string MainWindow = "mainWindow";
        const std::string CmsAddressEntry = "cmsAddressEntry";
        const std::string KeyEntry = "keyEntry";
        const std::string ResourcesPathEntry = "resourcesPathEntry";
        ...
        const std::string DisplayAdminButton = "displayAdminBtn";
        const std::string ExitButton = "exitBtn";
    }
